                            ...
                            <ul class="navbar-nav mr-auto" id="menu">
                                ...
                                <li class="nav-item submenu"><a class="nav-link" href="#">Cars</a>
                                    <ul>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="car-single.html">Car Details</a>
                                        </li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="how-work-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Streamlined processes for a
                                hassle-free experience</h2>
            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Stay informed and inspired for your next
                            journey</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
                    ...
                    <div class="highlighted-article-post wow fadeInUp">
                        ...
                        <div class="highlighted-article-body">
                            ...
                            <div class="article-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-solid fa-calendar-days"></i> sep 19, 2024</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- Article Meta End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="article-post wow fadeInUp">
                        ...
                        <div class="article-post-body">
                            ...
                            <div class="article-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-solid fa-calendar-days"></i> sep 20, 2024</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- Article Meta End -->
                            ...
                            <div class="article-post-content">
                                <h3><a href="#">Exploring the City: Best Urban Destinations for a Weekend
                                        Getaway</a></h3>
                    ...
                    <div class="article-post wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="article-post-body">
                            ...
                            <div class="article-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-solid fa-calendar-days"></i> sep 21, 2024</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- Article Meta End -->
                    ...
                    <div class="article-post wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="article-post-body">
                            ...
                            <div class="article-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-solid fa-calendar-days"></i> sep 22, 2024</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- Article Meta End -->
                            ...
                            <form id="newslettersForm" action="#" method="POST">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="section-icon-btn"><img
                                            src="images/arrow-white.svg" alt=""></button>
                                </div>
                            </form>
                        </div>
