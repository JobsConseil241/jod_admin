...
@section('content')
        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Liste des Marques</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="ti-btn ti-btn-soft-danger"
                                            data-hs-overlay="#cardModalDelete{{ $marque->id }}">
    ...
    <div id="hs-basic-modal" class="hs-overlay ti-modal hidden">
        <div class="ti-modal-box">
            <div class="ti-modal-content">
                <form action="{{ url('backend/marque/store') }}" method="POST">
                    @csrf
    ...
    @foreach ($marques as $marque)
        <div id="cardModalView{{ $marque->id }}" class="hs-overlay ti-modal hidden">
            <div class="ti-modal-box">
                <div class="ti-modal-content">
                    <form action="{{ url('backend/marque/update/' . $marque->id) }}" method="POST">
                        @csrf
                        <div class="ti-modal-header">
                            <h3 class="ti-modal-title">
                                Modifier une marque : {{ $marque->name }}
                            </h3>
                            <button type="button" class="hs-dropdown-toggle ti-modal-clode-btn"
                                data-hs-overlay="#hs-basic-modal">
                                <span class="sr-only">Close</span>
                        ...
                        <div class="ti-modal-body">
                            ...
                            <div class="mb-3">
                                <label for="input-label" class="ti-form-label">Nom</label>
                                <input type="text" name="name" value="{{ $marque->name }}" id="input-label"
                                    class="ti-form-input">
                            </div>

                            <div class="mb-3">
                                <label for="input-description" class="ti-form-label">Description</label>
                                <textarea class="ti-form-input" rows="3" name="description">{{ $marque->description }}</textarea>
                            </div>
                        </div>
                        <div class="ti-modal-footer">
                            <button type="button"
        ...
        <div id="cardModalDelete{{ $marque->id }}" class="hs-overlay ti-modal hidden">
            <div class="ti-modal-box">
                <div class="ti-modal-content">
                    <div class="ti-modal-header">
                        <h3 class="ti-modal-title">
                    ...
                    <div class="ti-modal-body">
                        <p class="mt-1 text-gray-800 dark:text-white/70">
                            Êtes-vous sûr de vouloir supprimer cette marque : {{ $marque->name }} ?
                        </p>
                    </div>
                    <div class="ti-modal-footer">
                        <form action="{{ url('backend/marque/update/' . $marque->id) }}" method="POST">
