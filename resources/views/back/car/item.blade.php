                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img alt="photo_interieur"
                                        src="{{ asset($car->vehicule_medias[0]->photo_interieur) ?? url('public/back/img/ecommerce/product-details/6.png')  }}">
                                </div>
                            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img alt="photo_dashboard"
                                        src="{{ asset($car->vehicule_medias[0]->photo_dashboard) ?? url('public/back/img/ecommerce/product-details/5.png')  }}">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="photo_interieur"
                                        src="{{ asset($car->vehicule_medias[0]->photo_interieur) ?? url('public/back/img/ecommerce/product-details/6.png')  }}">
