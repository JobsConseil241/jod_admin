                    ...
                    <div class="box-body">
                        <div class="swiper mySwiper2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/1.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-2" src="../assets/img/ecommerce/product-details/2.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-3" src="../assets/img/ecommerce/product-details/3.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-4" src="../assets/img/ecommerce/product-details/4.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-5" src="../assets/img/ecommerce/product-details/5.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-6" src="../assets/img/ecommerce/product-details/6.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-7" src="../assets/img/ecommerce/product-details/7.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-8" src="../assets/img/ecommerce/product-details/8.png">
                                </div>
                            </div>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/2.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/3.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/4.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/5.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/6.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/7.png">
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-image-1" src="../assets/img/ecommerce/product-details/8.png">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 xxl:col-span-4">
                <div class="box mb-0 border-0 shadow-none bg-transparent">
                    <div class="box-body xxl:px-0">
                        <div class="space-y-5">
                            <h5 class="font-bold text-xl text-gray-800 dark:text-white">Dolar 20000mAh 18W Fast Charging
                                Power Bank | Dual Output (Type C, 1
                            ...
                            <div class="sm:flex sm:space-x-6 rtl:space-x-reverse sm:space-y-0 space-y-2">
                                ...
                                <div class="flex space-x-2 rtl:space-x-reverse">
                                    ...
                                    <p class="text-gray-500 dark:text-white/70 text-sm space-x-2 rtl:space-x-reverse">2,262
                                        Reviews
                                    </p>
                                </div>
                                <div class="flex space-x-2 rtl:space-x-reverse">
                                    <span class="my-auto w-1.5 h-1.5 inline-block bg-gray-400 rounded-full"></span>
                                    <p class="text-gray-500 dark:text-white/70 text-sm space-x-2 rtl:space-x-reverse">3,252
                                        Units
                                        Sold</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <p class="my-auto font-medium text-sm text-gray-500 dark:text-white/70">Lorem ipsum dolor
                                    sit
                        ...
                        <div class="box shadow-none">
                            ...
                            <div class="box-body space-y-4">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <h5 class="font-normal text-gray-500 dark:text-white/70 text-sm my-auto w-28">Item :
                                    </h5>
                                    <img src="../assets/img/ecommerce/product-details/6.png" class="avatar rounded-sm"
                                        alt="Product-image">
                                </div>
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <h5 class="font-normal text-gray-500 dark:text-white/70 text-sm my-auto w-28">Color :
                                    </h5>
                                    <p class="font-medium text-sm">Red</p>
                                </div>
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <h5 class="font-normal text-gray-500 dark:text-white/70 text-sm my-auto w-28">Capacity
                                        :</h5>
                                    <p class="font-medium text-sm">2000 mAh</p>
                                </div>
                                <div class="sm:flex sm:space-x-3">
                                    <h5 class="font-normal text-gray-500 dark:text-white/70 text-sm my-auto w-28">Quantity
                                        :</h5>
                                ...
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <h5 class="font-normal text-gray-500 dark:text-white/70 text-sm my-auto w-28">Total :
                                    </h5>
                                    <p class="font-medium text-sm">$2000</p>
                                </div>
                                <p class="font-medium text-sm">Expected Delivery By Feb 25 ,2023</p>
                                <div>
                                    <a href="cart.html" class="w-full ti-btn ti-btn-primary">Add To Cart</a>
                                    <a href="checkout.html"
                                        class="w-full ti-btn ti-btn-outline ti-btn-outline-primary">Buy Now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-body pt-0 px-0">
                    ...
                    <div class="mt-6 px-6">
                            ...
                            <div class="space-y-2">
                                <div class="box">
                                        ...
                                        <div class="sm:flex justify-between">
                                            ...
                                            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                <div class="flex space-x-2 rtl:space-x-reverse">
                                                    <div class="product-rating">
                                                        <i
                                                            class="ri ri-star-fill text-yellow-500 text-base leading-none"></i>
                                                        <i
                                                            class="ri ri-star-fill text-yellow-500 text-base leading-none"></i>
                                                        <i
                                                            class="ri ri-star-fill text-yellow-500 text-base leading-none"></i>
                                    ...
                                    <div class="box-body p-3">
                                        ...
                                        <p class="my-2 text-gray-500 dark:text-white/70 text-xs">Very nice ! On the other
                                            hand,
                                            we
                        ...
                        <div id="product-spec-content-1" class="hidden" role="tabpanel">
                            ...
                            for any item is free of charge. If you decide to exchange that item again (i.e. more than once)
                            you
                            will
        ...
        <div class="col-span-12 xxl:col-span-3">
            <div class="box">
                ...
                <div class="box-body p-0">
                    <ul class="flex flex-col divide-y divide-gray-200 dark:divide-white/10">
                        <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                            <a href="products.html" class="w-full">
                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                    <img src="../assets/img/ecommerce/products/1.png"
                                    ...
                                    <div class="w-full my-auto">
                                        <div class="flex">
                                            ...
                                            <p class="ltr:ml-auto rtl:mr-auto text-base mb-0 font-semibold text-primary">
                                                $699</p>
                                        </div>
                                        <div class="flex">
                                            <p class="mb-0 flex">
                                                ...
                                                <span
                                                    class="text-gray-500 dark:text-white/70 ltr:ml-1 rtl:mr-1">(13,256)</span>
                                            </p>
                                            <span
                                                class="text-gray-500 dark:text-white/70 text-sm ltr:ml-auto rtl:mr-auto">$999</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                            <a href="products.html" class="w-full">
                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                    <img src="../assets/img/ecommerce/products/2.png"
                                        class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                        alt="product-image">
                                    <div class="w-full my-auto">
                                        <div class="flex">
                                        ...
                                        <div class="flex">
                                            <p class="mb-0 flex">
                                                ...
                                                <span
                                                    class="text-gray-500 dark:text-white/70 ltr:ml-1 rtl:mr-1">(15,256)</span>
                                            </p>
                                            <span
                                                class="text-gray-500 dark:text-white/70 text-sm ltr:ml-auto rtl:mr-auto">$599</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                            <a href="products.html" class="w-full">
                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                    <img src="../assets/img/ecommerce/products/3.png"
                                        class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                        alt="product-image">
                                    <div class="w-full my-auto">
                                        <div class="flex">
                                        ...
                                        <div class="flex">
                                            <p class="mb-0 flex">
                                                ...
                                                <span
                                                    class="text-gray-500 dark:text-white/70 ltr:ml-1 rtl:mr-1">(10,456)</span>
                                            </p>
                                            <span
                                                class="text-gray-500 dark:text-white/70 text-sm ltr:ml-auto rtl:mr-auto">$2599</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                            <a href="products.html" class="w-full">
                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                    <img src="../assets/img/ecommerce/products/4.png"
                                        class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                        alt="product-image">
                                    <div class="w-full my-auto">
                                        <div class="flex">
                                        ...
                                        <div class="flex">
                                            <p class="mb-0 flex">
                                                ...
                                                <span
                                                    class="text-gray-500 dark:text-white/70 ltr:ml-1 rtl:mr-1">(20,263)</span>
                                            </p>
                                            <span
                                                class="text-gray-500 dark:text-white/70 text-sm ltr:ml-auto rtl:mr-auto">$499</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                            <a href="products.html" class="w-full">
                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                    <img src="../assets/img/ecommerce/products/5.png"
                                        class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                        alt="product-image">
                                    <div class="w-full my-auto">
                                        <div class="flex">
                                        ...
                                        <div class="flex">
                                            ...
                                            <span
                                                class="text-gray-500 dark:text-white/70 text-sm ltr:ml-auto rtl:mr-auto">$299</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="box-footer">
                    <a href="products.html" class="ti-btn ti-btn-primary py-1 w-full">Shop Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-12 divide-x rtl:divide-x-reverse divide-gray-200 dark:divide-white/10">
                ...
                <div class="box mb-0 border-0 shadow-none">
                    <div class="box-body">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div>
                                <span class="block text-sm font-semibold dark:text-white max-w-[200px] truncate">High
                                    Quality
                                    Products</span>
                                ...
                                <g id="SvgjsG1014"><svg xmlns="http://www.w3.org/2000/svg" id="svg6485" version="1.1"
                                        ...
                                        <g id="layer1" transform="translate(0 -1020.362)" fill="#6366f1"
                                            ...
                                            <path
                                                ...
                                                id="path12487" fill="#6366f1" fill-opacity="1" fill-rule="nonzero"
                                                ...
                                                color-rendering="auto" display="inline" image-rendering="auto"
                                                opacity="1" shape-rendering="auto" text-rendering="auto"
                                                visibility="visible" class="color000 svgShape !fill-primary">
                                            </path>
                                        </g>
                                    </svg></g>
                            </svg>
            ...
            <div class="col-span-12 xl:col-span-3 lg:col-span-6">
                <div class="box mb-0 border-0 shadow-none">
                    <div class="box-body">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            <svg class="w-[3rem] h-[3rem] my-auto" id="SvgjsSvg1021" xmlns="http://www.w3.org/2000/svg"
                                version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
