    ...
    <div class="grid grid-cols-12 gap-x-6">
        <div class="col-span-12">
            <div class="box !bg-transparent border-0 shadow-none">
                <form method="post" action="{{ url('backend/car/etat/' . $car->id. '/'.$car->etats[0]->date) }}">
                    @csrf
            ...
            'date' => ['label' => 'Date', 'type' => 'date'],
                    ...
                    <div class="box-footer text-end border-t-0 px-0">
                        <button type="submit" class="ti-btn ti-btn-primary"><i class="ri-add-line"></i>Modifier</button>
