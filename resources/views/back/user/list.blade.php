                ...
                <form action="{{ url('backend/user/create') }}" method="POST">
                    ...
                    <div class="ti-modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="last_name" id="input-lastname" class="ti-form-input" required>
                        </div>

                        <div class="mb-3">
                            <label for="input-firstname" class="ti-form-label">Prénom</label>
                            <input type="text" name="first_name" id="input-firstname" class="ti-form-input">
                        </div>

                        <div class="mb-3">
                            <label for="input-email" class="ti-form-label">Email</label>
                            <input type="email" name="email" id="input-email" class="ti-form-input" required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="hs-select-label" class="ti-form-select-label">Rôle</label>
