...
class CarController extends BaseController
{
    ...
    public function add_Vehicule(Request $request)
    {
        ...
        try {
            ...
            $rules = [
                ...
                'fournisseur_id' => 'required|exists:users,id', // Vérifie que l'ID existe dans la table `users`
            ];
            ...
            $Vehicule = Vehicule::create([
                ...
                'fournisseur_id' => $datas['supplier_id'],
    ...
    public function edit_Vehicule(Request $request)
    {
        try {
            ...
            $Vehicule = Vehicule::find($datas['id']);
            ...
            return $this->sendResponse($data, "Edit Vehicule successfully");
        } catch (Exception $e) {
